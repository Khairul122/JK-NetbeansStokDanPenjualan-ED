...
void cetak_nota(){
        try {
            ...
            param.put("kodeTransaksi",noTF.getText());
    ...
    public void tampil() {
    Object header[]={"Kode Transaksi","Tanggal Transaksi", "Nama Pembeli", "Kode Barang", "Nama Barang","Harga Jual", "Jumlah", "Total Harga"};
...
private void otomatis() {
    try {
        setKoneksi();
        String sql = "SELECT MAX(KodeTransaksi) FROM jual";
        ...
        if (rs.next()) {
            ...
            if (lastCode != null) {
                ...
                String newCode = String.format("TP%03d", newNumber);
                noTF.setText(newCode);
            } else {
                noTF.setText("TP001");
            }
        } else {
...
private void tgl(){
    ...
    private void initComponents() {
        ...
        pembelianTF = new javax.swing.JTextField();
        ...
        tambahBT2 = new javax.swing.JButton();
        ...
        pembelianTF.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        pembelianTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pembelianTFActionPerformed(evt);
            }
        });
        pembelianTF.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                pembelianTFKeyReleased(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addComponent(pembelianTF, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(44, 44, 44))))
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(pembelianTF, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(14, 14, 14)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(kembaliTF, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
                    .addComponent(jLabel10))
                .addContainerGap())
        );

        jPanel3.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 330, 560, 190));
        ...
        tambahBT2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tambahBT2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Tambah.png"))); // NOI18N
        tambahBT2.setText("KERANJANG");
        tambahBT2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tambahBT2ActionPerformed(evt);
            }
        });
        ...
        jPanel3.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 20, -1, 302));
    ...
    private void simpanBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanBTActionPerformed
       try {
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/penjualan", "root", "");
        
        // Mendefinisikan kueri SQL untuk menyimpan data
        String sql = "INSERT INTO jual (KodeTransaksi, TanggalTransaksi, Nama, KodeBarang, NamaBarang, HargaJual, Jumlah, TotalHarga, UangBayar, UangKembali) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        
        // Persiapan statement SQL
        PreparedStatement statement = conn.prepareStatement(sql);
        
        // Menyimpan data dari JTable1 ke database
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            statement.setString(1, jTable1.getValueAt(i, 0).toString()); // Kode Transaksi
            statement.setString(2, jTable1.getValueAt(i, 1).toString()); // Tanggal Transaksi
            statement.setString(3, jTable1.getValueAt(i, 2).toString()); // Nama Pembeli
            statement.setString(4, jTable1.getValueAt(i, 3).toString()); // Kode Barang
            statement.setString(5, jTable1.getValueAt(i, 4).toString()); // Nama Barang
            statement.setString(6, jTable1.getValueAt(i, 5).toString()); // Harga Jual
            statement.setString(7, jTable1.getValueAt(i, 6).toString()); // Jumlah
            statement.setString(8, jTable1.getValueAt(i, 7).toString()); // Total Harga
            statement.setString(9, bayarTF.getText()); // Uang Bayar dari JTextField
            statement.setString(10, kembaliTF.getText()); // Uang Kembali dari JTextField
            
            // Eksekusi kueri SQL untuk menyimpan data
    ...
    private void bayarTFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_bayarTFKeyReleased
       try {
        // Mengambil nilai dari pembelianTF dan bayarTF
        int pembelian = Integer.parseInt(pembelianTF.getText());
        int bayar = Integer.parseInt(bayarTF.getText());
        
        // Menghitung kembali
        int kembali = bayar - pembelian;
        
        // Menampilkan hasil kembali di kembaliTF
        kembaliTF.setText(String.valueOf(kembali));
    } catch (NumberFormatException e) {
        // Penanganan kesalahan jika input tidak valid
        // Misalnya, menampilkan pesan kesalahan atau mengatur kembaliTF menjadi kosong
        kembaliTF.setText("");
    }
    ...
    private void tambahBT2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahBT2ActionPerformed
             String lastTransactionCode = ""; // Inisialisasi dengan string kosong untuk kasus pertama kali penggunaan
     DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
     int rowCount = model.getRowCount();
     if (rowCount > 0) {
         lastTransactionCode = (String) model.getValueAt(rowCount - 1, 0);
     }

     // Mengumpulkan data dari bidang input
     String kodeTransaksi = noTF.getText(); // Menggunakan nilai dari noTF untuk kode transaksi
     Date tanggalTransaksiDate = tanggalTF.getDate();
     SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
     String tanggalTransaksi = sdf.format(tanggalTransaksiDate);
     String namaPembeli = supTF.getText();
     String kodeBarang = kodeTF.getText();
     String namaBarang = namaTF.getText();
     String hargaJual = hjualTF.getText();
     String jumlah = jumlahTF.getText();
     String totalHarga = thargaTF.getText();

     // Membuat sebuah array untuk data baris
     Object[] row = {kodeTransaksi, tanggalTransaksi, namaPembeli, kodeBarang, namaBarang, hargaJual, jumlah, totalHarga};

     // Menambahkan baris baru ke dalam tabel
     model.addRow(row);
     model.fireTableDataChanged(); // Memperbarui tampilan UI tabel

     // Menghitung total pembelian dari semua baris pada tabel
     int totalPembelian = 0;
     for (int i = 0; i < model.getRowCount(); i++) {
         totalPembelian += Integer.parseInt(model.getValueAt(i, 7).toString());
     }

     // Menampilkan total pembelian di pembelianTF
     pembelianTF.setText(String.valueOf(totalPembelian));

     // Membersihkan bidang input setelah data ditambahkan
     tanggalTF.setDate(null);
     supTF.setText("");
     kodeTF.setText("");
     namaTF.setText("");
     ...
     jumlahTF.setText("");
     thargaTF.setText("");
    }//GEN-LAST:event_tambahBT2ActionPerformed

    private void pembelianTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pembelianTFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pembelianTFActionPerformed

    private void pembelianTFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pembelianTFKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_pembelianTFKeyReleased
    ...
    private javax.swing.JTextField pembelianTF;
    ...
    private javax.swing.JButton tambahBT2;
